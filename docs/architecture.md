...
| `api.ts` | GET /api/health, /api/profile/:username, /api/config; POST /api/recommend {username, lang}, /api/explain {username, ids, lang} |
| `index.ts` | Hono + Vite middleware (dev) o serve dist (prod); bind 127.0.0.1 |
